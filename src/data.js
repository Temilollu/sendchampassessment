...
export const pricingPlans = [
  {
    header: "SMS",
    icon: <Icon as={BsFillChatLeftFill} />,
    sendKey: "To Send SMS",
    value: "/sms",
    receiveKey: "To Receive SMS",
  },
  {
    header: "Voice",
    icon: <Icon as={BsVoicemail} />,
    sendKey: "To Make Calls",
    value: "/sec",
    receiveKey: "To Receive Calls",
  },
  {
    header: "Email",
    icon: <Icon as={BsWalletFill} />,
    sendKey: "Price Per Mail",
    value: "/mail",
    receiveKey: "",
  },
  {
    ...
    sendKey: "To Send Message",
    value: "/msg",
    receiveKey: "To Receive Message",
  },
  {
    header: "Verification",
